...
public class ProducerDemo {
    public static void main(String[] args) throws Exception {
        ...
        //设置序列化器 -》 kakfq的数据是用的网络传输的，所以里面都是二进制的数据。
         ...
         *
         * 如果参数为-1：
         *  如果判断一条消息发送成功呢？首先消息要写入leader partition，这些消息还需要被另外的所有的这个
         *  分区的副本同步了 才算发送成功。
         *
         * Kafka里面的分区是有副本的。比如有一个主题topica
         * 这个主题里面有2个 partition，每个分区有3个副本
         * p0:
         *   leader partition ,follower partition ,follower partiton
         * p1:
         *   leader partition ,follower partition,follower partition
         *
         * 如果参数是1：
         *  重要发送的消息能写到leader partition就算写入成功，然后服务端就返回相应就可以了
         *  默认就是用的这个参数
         *  有可能会丢数据。
        ...
        /**
         * 这个值，默认是1M
         * 代表的是 生产者发送消息的时候，最大的一条信息（注意说的不是批次）
