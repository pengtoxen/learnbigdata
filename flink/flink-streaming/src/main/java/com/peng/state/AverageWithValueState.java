 ...
 */
public class AverageWithValueState extends RichFlatMapFunction<Tuple2<String, Long>, Tuple2<String, Double>> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        keyedStream.flatMap(new AverageWithValueState()).print();
